...
const About = () => {
  return <section className="py-24 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 mb-8 leading-relaxed max-w-3xl mx-auto">With over a decade of experience in chartered accountancy, we've built our reputation on delivering exceptional financial services that drive business success. Our team combines traditional expertise with innovative solutions to meet the evolving needs of modern businesses.</p>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {stats.map((stat, index) => <div key={stat.label} className="text-center p-6 rounded-xl bg-white/70 backdrop-blur-sm border border-white/20 hover:bg-white/90 transition-all duration-300 hover:scale-105" style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => <div key={member.name} className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 text-center hover:bg-white/95 transition-all duration-300 hover:scale-105 border border-white/20" style={{
